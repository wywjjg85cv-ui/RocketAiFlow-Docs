...
export default withNextra({
  ...
  async redirects() {
    return [
      ...
      { source: "/11-trunk-configuration", destination: "/deploy/deployment-overview", permanent: false },
      ...
      { source: "/28-telephony-architecture", destination: "/deploy/deployment-overview", permanent: false },
      ...
      { source: "/deploy/on-premise-deployment", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/deploy/cloud-deployment", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/deploy/telephony-architecture", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/deploy/trunk-configuration", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/deploy/dedicated", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/deploy/self-hosted", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/trunk", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/trunk/:path*", destination: "/deploy/deployment-overview", permanent: false },
      ...
      { source: "/build/provider-flexibility", destination: "/integrations/telephony", permanent: false },
      {
      ...
      { source: "/integrate/telephony-sip-pbx", destination: "/integrations/telephony", permanent: false },
      ...
      { source: "/deploy/telephony-and-system-fit", destination: "/deploy/deployment-overview", permanent: false },
      { source: "/operate/monitoring-and-visibility", destination: "/observe/monitoring-and-visibility", permanent: false },
      { source: "/operate/campaign-analytics", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/endpoint-and-trunk-monitoring", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/pre-provisioned-dashboards", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/observe/logs-overview", destination: "/observe/logs-and-traces", permanent: false },
      { source: "/observe/traces-overview", destination: "/observe/logs-and-traces", permanent: false },
      { source: "/operate/logs-overview", destination: "/observe/logs-and-traces", permanent: false },
      { source: "/operate/traces-overview", destination: "/observe/logs-and-traces", permanent: false },
      { source: "/operate/logs-and-troubleshooting", destination: "/observe/logs-and-traces", permanent: false },
      { source: "/operate/performance-review", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      ...
      { source: "/operate/infrastructure-monitoring", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/asterisk-monitoring", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/container-monitoring", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/database-monitoring", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/real-time-performance-metrics", destination: "/observe/pre-provisioned-dashboards", permanent: false },
      { source: "/operate/time-range-reporting", destination: "/observe/pre-provisioned-dashboards", permanent: false },
