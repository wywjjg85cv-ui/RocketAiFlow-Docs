...
const breadcrumbLabels: Record<Locale, BreadcrumbLabels> = {
  en: {
    ...
    pages: {
      ...
      "/run-workflows/ai-dialer-flows/import-contacts": "Import Contacts",
      "/run-workflows/contact-inbounds": "Contact Inbounds",
      "/run-workflows/ai-dialer-flows/call-records": "Call Records",
  ...
  it: {
    ...
    pages: {
      ...
      "/run-workflows/ai-inbound-routing": "AI Inbound Routing",
      "/run-workflows/ai-dialer-flows": "AI Dialer Flows",
      "/run-workflows/ai-dialer-flows/import-contacts": "Importa contatti",
      "/run-workflows/contact-inbounds": "Contatti inbound",
      "/run-workflows/ai-dialer-flows/call-records": "Registro chiamate",
