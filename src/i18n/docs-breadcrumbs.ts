...
const breadcrumbLabels: Record<Locale, BreadcrumbLabels> = {
  en: {
    ...
    pages: {
      ...
      "/run-workflows/ai-inbound-routing": "AI Inbound Routing",
      "/run-workflows/ai-dialer-flows": "AI Dialer Flows",
      "/run-workflows/dialer-pacing-and-limits": "Dialer Pacing and Limits",
      "/run-workflows/import-contacts": "Import Contacts",
      "/run-workflows/contact-inbounds": "Contact Inbounds",
      "/run-workflows/call-records": "Call Records",
      "/run-workflows/call-history-and-review": "Call History and Review",
      ...
      "/observe/monitoring-and-visibility": "Monitoring and Visibility",
      "/observe/pre-provisioned-dashboards": "Pre-Provisioned Dashboards",
      "/observe/dialer-dashboard-panels": "Dialer Dashboard Panels",
      "/observe/logs-and-traces": "Logs and Traces",
      "/troubleshoot/investigating-workflow-issues": "Investigating Workflow Issues",
  ...
  it: {
    ...
    pages: {
      ...
      "/run-workflows/ai-inbound-routing": "AI Inbound Routing",
      "/run-workflows/ai-dialer-flows": "AI Dialer Flows",
      "/run-workflows/dialer-pacing-and-limits": "Pacing e limiti dialer",
      "/run-workflows/import-contacts": "Importa contatti",
      "/run-workflows/contact-inbounds": "Contact Inbounds",
      "/run-workflows/call-records": "Call Records",
      "/run-workflows/call-history-and-review": "Storico e revisione chiamate",
      "/run-workflows/phone": "Phone",
      "/integrations": "Integrazioni",
      ...
      "/observe/monitoring-and-visibility": "Monitoring e visibilità",
      "/observe/pre-provisioned-dashboards": "Dashboard preconfigurate",
      "/observe/dialer-dashboard-panels": "Pannelli Dashboard Dialer",
      "/observe/logs-and-traces": "Log e trace",
      "/troubleshoot/investigating-workflow-issues": "Analisi problemi workflow",
      "/troubleshoot/troubleshooting": "Troubleshooting",
      "/troubleshoot/faq": "FAQ",
      "/legal": "Stato legale",
