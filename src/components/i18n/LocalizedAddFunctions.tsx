...
const addFunctionsCopy: Record<Locale, AddFunctionsCopy> = {
  ...
  it: {
    ...
    bestPractices: {
      ...
      paragraphs: [],
      items: [
        "mantieni lo scope della function legato a una sola azione di business",
        "passa solo i parametri richiesti da quell'azione",
        "usa nomi chiari per operatori e implementatori",
        "mantieni le descrizioni abbastanza specifiche da far capire quando usare la function",
        "evita di combinare azioni non correlate nello stesso endpoint o nello stesso schema"
      ]
    },
    validation: {
