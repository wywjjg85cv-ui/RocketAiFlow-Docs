...
const tocCopy = {
  en: {
    ...
    introduction: {
      ...
      telephonyPilotSetup: "Telephony and deploy path",
    ...
    quickstart: {
      ...
      addInitialFunctions: "4. Optional functions",
  ...
  it: {
    ...
    introduction: {
      ...
      telephonyPilotSetup: "Telefonia e percorso deploy",
    ...
    quickstart: {
      ...
      addInitialFunctions: "4. Functions opzionali",
